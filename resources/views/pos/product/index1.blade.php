                    ...
                    <table class="min-w-max w-full table-auto">
                        <thead>
                            <tr class="bg-gray-200 text-gray-600 uppercase text-sm leading-normal">
                                <th class="py-3 px-6 text-left">English</th>
                                <th class="py-3 px-6 text-left">Khmer</th>
                            ...
                            <tr class="border-b border-gray-200 hover:bg-gray-100">
                                <td class="py-3 px-6 text-left whitespace-nowrap">
                                    <div class="flex items-center">
                                        <span class="font-medium">{{$product->en_name}}</span>
                                    </div>
                                </td>
                                <td class="py-3 px-6 text-left">
                                    <div class="flex items-center">
                                        <span>{{$product->kh_name}}</span>
                                    </div>
                                </td>
                                <td class="py-3 px-6 text-center">
                                    <span class="bg-purple-200 git-purple-600 py-1 px-3 rounded-full text-xs">{{$product->code}}</span>
                                </td>
                                <td class="py-3 px-6 text-center">
                                    <div class="flex items-center justify-center">
                                        <img class=" rounded-full border-gray-200 border transform hover:scale-125" src="{{ asset('img/'.$product->image.'.jpg') }}" width="20px" height="20px">
                                    </div>
                                </td>
