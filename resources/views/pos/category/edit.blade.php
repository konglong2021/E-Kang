             ...
             <div class="panel border-primary no-border border-3-top">
                <div class="panel-heading">
                    <div class="panel-title col-xs-12">
                        <h5>Categoies <small>Update Category</small></h5>
                    </div>
                    <div class=" text-right">
                        <div class="text-center">
                            <a href="{{ route('category.index') }}" class="btn btn-primary btn-animated btn-wide">
                                <span class="visible-content">Categories List</span>
                        ...
                        <div class="form-group  col-md-6 ">
                            ...
                            <div class="col-md-6 ">
                                ...
                                <select class="selectpicker" multiple data-live-search="true" name="brands[]">
                                    ...
                                    <option value="{{ $id }}" {{ (in_array($id, old('brands', [])) || $category->brands->contains($id)) ? 'selected' : '' }}>{{ $brand }}</option>
                                    @endforeach
