             ...
             <div class="panel border-primary no-border border-3-top">
                <div class="panel-heading">
                    <div class="panel-title col-xs-12">
                        <h5>Permission <small>List All</small></h5>
                    </div>

                    <div class=" text-right">
                        <div class="text-center">
                            <a href="{{ route('permission.create') }}" class="btn btn-primary btn-animated btn-wide">
                                <span class="visible-content">Add Permission</span>
                            ...
                            <table id="example" class="display table table-striped table-bordered" width="100%">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('permission.edit', $permission->id) }}" class="btn btn-success icon-only"><i class="fa fa-pencil"></i></a>
                                           
                                            {{-- <a href="" class="btn btn-danger icon-only"><i class="fa fa-trash-o"></i></a> --}}
                                            <form class="inline-block fa" action="{{ route('permission.destroy', $permission->id) }}" method="POST" onsubmit="return confirm('Are you sure?');">
